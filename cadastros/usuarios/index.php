                        ...
                        <tr class="<?= $classe ?>">
                            ...
                            <td>
                                <div class="btn-group btn-group-sm">
                                    <a href="index.php?rotina=2&mod=1&id=<?= $u['id_usuario'] ?>" class="btn btn-warning"
                                        title="Editar">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <?php if ($u['ativo'] == "S") { ?>
                                        <a href="index.php?rotina=2&mod=3&id=<?= $u['id_usuario'] ?>&ativo=N"
                                            class="btn btn-danger" title="Inativar">
                                            <i class="fa-regular fa-circle-xmark "></i>
                                        </a>
                                    <?php } else { ?>
                                        <a href="index.php?rotina=2&mod=3&id=<?= $u['id_usuario'] ?>&ativo=S"
