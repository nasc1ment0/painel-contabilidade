                        ...
                        <tr class="<?= $classe ?>">
                            ...
                            <td>
                                <div class="btn-group btn-group-sm">
                                    <a href="index.php?rotina=6&mod=1&id=<?= $t['id_tp_mensagem'] ?>" class="btn btn-warning"
                                        title="Editar">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <?php if ($t['ativo'] == "S") { ?>
                                        <a href="index.php?rotina=6&mod=3&id=<?= $t['id_tp_mensagem'] ?>&ativo=N"
                                            class="btn btn-danger" title="Inativar">
                                            <i class="fa-regular fa-circle-xmark "></i>
                                        </a>
                                    <?php } else { ?>
                                        <a href="index.php?rotina=6&mod=3&id=<?= $t['id_tp_mensagem'] ?>&ativo=S"
